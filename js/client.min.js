...
b==navigator.plugins.length-1?a+navigator.plugins[b].name:a+(navigator.plugins[b].name+", ");return a};b.prototype.hasJava=function(){return navigator.javaEnabled()};b.prototype.getJavaVersion=function(){return deployJava.getJREs().toString()};b.prototype.hasFlash=function(){return navigator.plugins["Shockwave Flash"]?!0:!1};b.prototype.getFlashVersion=function(){return this.hasFlash()?(objPlayerVersion=swfobject.getFlashPlayerVersion(),objPlayerVersion.major+"."+objPlayerVersion.minor+"."+objPlayerVersion.release):
""};b.prototype.hasSilverlight=function(){return navigator.plugins["Silverlight Plug-In"]?!0:!1};b.prototype.getSilverlightVersion=function(){return this.hasSilverlight()?navigator.plugins["Silverlight Plug-In"].description:""};b.prototype.hasMimeTypes=function(){return navigator.mimeTypes.length?!0:!1};b.prototype.getMimeTypes=function(){for(var a="",b=0;b<navigator.mimeTypes.length;b++)a=b==navigator.mimeTypes.length-1?a+navigator.mimeTypes[b].description:a+(navigator.mimeTypes[b].description+", ");
...
"|"+b.localAddr+"|"+b.ipv6+"|"):a(null)})};e.ClientJS=b})(window);(function(){function e(a,b){if(a===b)return 0;if(0===a.length)return b.length;if(0===b.length)return a.length;var c=Array(b.length+1),d,h,g,k,e;for(g=0;g<c.length;++g)c[g]=g;for(g=0;g<a.length;++g){h=g+1;for(k=0;k<b.length;++k)d=h,h=c[k]+(a.charAt(g)===b.charAt(k)?0:1),e=d+1,h>e&&(h=e),e=c[k+1]+1,h>e&&(h=e),c[k]=d;c[k]=h}return h}function b(){this.c=this.z=this.y=this.x=0;this.window=Array(7)}function a(a,c){for(var p=["",""],d=671226215,h=671226215,g=new b,k=0,e=a.length;k<e;k++){d=(16777619*d^a[k])>>>
0;h=(16777619*h^a[k])>>>0;g.update(a[k]);if(k===e-1||g.sum()%c===c-1)p[0]+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(d&63),d=671226215;if(k===e-1||g.sum()%(2*c)===2*c-1)p[1]+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(h&63),h=671226215}return p}function r(a,b){return 100*(1-e(a,b)/Math.max(a.length,b.length))}var c={},d=!1;"undefined"!==typeof module&&module.exports?exports=module.exports=c:(this.ctph=c,d=!0);b.prototype.update=function(a){this.y-=
...
this.oldMimeType+'" hidden="true" />')}}};d.writePluginTag();if(null==d.locale){a=null;if(null==a)try{a=navigator.userLanguage}catch(f){}if(null==a)try{a=navigator.systemLanguage}catch(f){}if(null==a)try{a=navigator.language}catch(f){}null!=a&&(a.replace("-","_"),d.locale=a)}return d}();var Detector=function(){var e=["monospace","sans-serif","serif"],b=document.getElementsByTagName("body")[0],a=document.createElement("span");a.style.fontSize="72px";a.innerHTML="mmmmmmmmmmlli";var r={},c={},d;for(d in e)a.style.fontFamily=e[d],b.appendChild(a),r[e[d]]=a.offsetWidth,c[e[d]]=a.offsetHeight,b.removeChild(a);this.detect=function(d){var q=!1,p;for(p in e){a.style.fontFamily=d+","+e[p];b.appendChild(a);var t=a.offsetWidth!=r[e[p]]||a.offsetHeight!=c[e[p]];b.removeChild(a);q=q||t}return q}};function murmurhash3_32_gc(e,b){var a,r,c,d,f;a=e.length&3;r=e.length-a;c=b;for(f=0;f<r;)d=e.charCodeAt(f)&255|(e.charCodeAt(++f)&255)<<8|(e.charCodeAt(++f)&255)<<16|(e.charCodeAt(++f)&255)<<24,++f,d=3432918353*(d&65535)+((3432918353*(d>>>16)&65535)<<16)&4294967295,d=d<<15|d>>>17,d=461845907*(d&65535)+((461845907*(d>>>16)&65535)<<16)&4294967295,c^=d,c=c<<13|c>>>19,c=5*(c&65535)+((5*(c>>>16)&65535)<<16)&4294967295,c=(c&65535)+27492+(((c>>>16)+58964&65535)<<16);d=0;switch(a){case 3:d^=(e.charCodeAt(f+
2)&255)<<16;case 2:d^=(e.charCodeAt(f+1)&255)<<8;case 1:d^=e.charCodeAt(f)&255,d=3432918353*(d&65535)+((3432918353*(d>>>16)&65535)<<16)&4294967295,d=d<<15|d>>>17,c^=461845907*(d&65535)+((461845907*(d>>>16)&65535)<<16)&4294967295}c^=e.length;c^=c>>>16;c=2246822507*(c&65535)+((2246822507*(c>>>16)&65535)<<16)&4294967295;c^=c>>>13;c=3266489909*(c&65535)+((3266489909*(c>>>16)&65535)<<16)&4294967295;return(c^c>>>16)>>>0};var swfobject=function(){function e(){if(!A){try{var a=n.getElementsByTagName("body")[0].appendChild(n.createElement("span"));a.parentNode.removeChild(a)}catch(b){return}A=!0;for(var a=F.length,c=0;c<a;c++)F[c]()}}function b(a){A?a():F[F.length]=a}function a(a){if("undefined"!=typeof u.addEventListener)u.addEventListener("load",a,!1);else if("undefined"!=typeof n.addEventListener)n.addEventListener("load",a,!1);else if("undefined"!=typeof u.attachEvent)v(u,"onload",a);else if("function"==typeof u.onload){var b=
u.onload;u.onload=function(){b();a()}}else u.onload=a}function r(){var a=n.getElementsByTagName("body")[0],b=n.createElement("object");b.setAttribute("type","application/x-shockwave-flash");var d=a.appendChild(b);if(d){var h=0;(function(){if("undefined"!=typeof d.GetVariable){var k=d.GetVariable("$version");k&&(k=k.split(" ")[1].split(","),l.pv=[parseInt(k[0],10),parseInt(k[1],10),parseInt(k[2],10)])}else if(10>h){h++;setTimeout(arguments.callee,10);return}a.removeChild(b);d=null;c()})()}else c()}
function c(){var a=y.length;if(0<a)for(var b=0;b<a;b++){var c=y[b].id,h=y[b].callbackFn,g={success:!1,id:c};if(0<l.pv[0]){var e=k(c);if(e)if(!x(y[b].swfVersion)||l.wk&&312>l.wk)if(y[b].expressInstall&&f()){g={};g.data=y[b].expressInstall;g.width=e.getAttribute("width")||"0";g.height=e.getAttribute("height")||"0";e.getAttribute("class")&&(g.styleclass=e.getAttribute("class"));e.getAttribute("align")&&(g.align=e.getAttribute("align"));for(var n={},e=e.getElementsByTagName("param"),m=e.length,D=0;D<
m;D++)"movie"!=e[D].getAttribute("name").toLowerCase()&&(n[e[D].getAttribute("name")]=e[D].getAttribute("value"));q(g,n,c,h)}else p(e),h&&h(g);else B(c,!0),h&&(g.success=!0,g.ref=d(c),h(g))}else B(c,!0),h&&((c=d(c))&&"undefined"!=typeof c.SetVariable&&(g.success=!0,g.ref=c),h(g))}}function d(a){var b=null;(a=k(a))&&"OBJECT"==a.nodeName&&("undefined"!=typeof a.SetVariable?b=a:(a=a.getElementsByTagName("object")[0])&&(b=a));return b}function f(){return!G&&x("6.0.65")&&(l.win||l.mac)&&!(l.wk&&312>l.wk)}
function q(a,b,c,d){G=!0;J=d||null;L={success:!1,id:c};var g=k(c);if(g){"OBJECT"==g.nodeName?(E=t(g),H=null):(E=g,H=c);a.id="SWFObjectExprInst";if("undefined"==typeof a.width||!/%$/.test(a.width)&&310>parseInt(a.width,10))a.width="310";if("undefined"==typeof a.height||!/%$/.test(a.height)&&137>parseInt(a.height,10))a.height="137";n.title=n.title.slice(0,47)+" - Flash Player Installation";d=l.ie&&l.win?"ActiveX":"PlugIn";d="MMredirectURL="+u.location.toString().replace(/&/g,"%26")+"&MMplayerType="+
d+"&MMdoctitle="+n.title;b.flashvars="undefined"!=typeof b.flashvars?b.flashvars+("&"+d):d;l.ie&&l.win&&4!=g.readyState&&(d=n.createElement("div"),c+="SWFObjectNew",d.setAttribute("id",c),g.parentNode.insertBefore(d,g),g.style.display="none",function(){4==g.readyState?g.parentNode.removeChild(g):setTimeout(arguments.callee,10)}());h(a,b,c)}}function p(a){if(l.ie&&l.win&&4!=a.readyState){var b=n.createElement("div");a.parentNode.insertBefore(b,a);b.parentNode.replaceChild(t(a),b);a.style.display="none";
(function(){4==a.readyState?a.parentNode.removeChild(a):setTimeout(arguments.callee,10)})()}else a.parentNode.replaceChild(t(a),a)}function t(a){var b=n.createElement("div");if(l.win&&l.ie)b.innerHTML=a.innerHTML;else if(a=a.getElementsByTagName("object")[0])if(a=a.childNodes)for(var c=a.length,d=0;d<c;d++)1==a[d].nodeType&&"PARAM"==a[d].nodeName||8==a[d].nodeType||b.appendChild(a[d].cloneNode(!0));return b}function h(a,b,c){var d,h=k(c);if(l.wk&&312>l.wk)return d;if(h)if("undefined"==typeof a.id&&
(a.id=c),l.ie&&l.win){var g="",e;for(e in a)a[e]!=Object.prototype[e]&&("data"==e.toLowerCase()?b.movie=a[e]:"styleclass"==e.toLowerCase()?g+=' class="'+a[e]+'"':"classid"!=e.toLowerCase()&&(g+=" "+e+'="'+a[e]+'"'));e="";for(var f in b)b[f]!=Object.prototype[f]&&(e+='<param name="'+f+'" value="'+b[f]+'" />');h.outerHTML='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"'+g+">"+e+"</object>";I[I.length]=a.id;d=k(a.id)}else{f=n.createElement("object");f.setAttribute("type","application/x-shockwave-flash");
for(var m in a)a[m]!=Object.prototype[m]&&("styleclass"==m.toLowerCase()?f.setAttribute("class",a[m]):"classid"!=m.toLowerCase()&&f.setAttribute(m,a[m]));for(g in b)b[g]!=Object.prototype[g]&&"movie"!=g.toLowerCase()&&(a=f,e=g,m=b[g],c=n.createElement("param"),c.setAttribute("name",e),c.setAttribute("value",m),a.appendChild(c));h.parentNode.replaceChild(f,h);d=f}return d}function g(a){var b=k(a);b&&"OBJECT"==b.nodeName&&(l.ie&&l.win?(b.style.display="none",function(){if(4==b.readyState){var c=k(a);
if(c){for(var d in c)"function"==typeof c[d]&&(c[d]=null);c.parentNode.removeChild(c)}}else setTimeout(arguments.callee,10)}()):b.parentNode.removeChild(b))}function k(a){var b=null;try{b=n.getElementById(a)}catch(c){}return b}function v(a,b,c){a.attachEvent(b,c);C[C.length]=[a,b,c]}function x(a){var b=l.pv;a=a.split(".");a[0]=parseInt(a[0],10);a[1]=parseInt(a[1],10)||0;a[2]=parseInt(a[2],10)||0;return b[0]>a[0]||b[0]==a[0]&&b[1]>a[1]||b[0]==a[0]&&b[1]==a[1]&&b[2]>=a[2]?!0:!1}function m(a,b,c,d){if(!l.ie||
!l.mac){var h=n.getElementsByTagName("head")[0];h&&(c=c&&"string"==typeof c?c:"screen",d&&(K=w=null),w&&K==c||(d=n.createElement("style"),d.setAttribute("type","text/css"),d.setAttribute("media",c),w=h.appendChild(d),l.ie&&l.win&&"undefined"!=typeof n.styleSheets&&0<n.styleSheets.length&&(w=n.styleSheets[n.styleSheets.length-1]),K=c),l.ie&&l.win?w&&"object"==typeof w.addRule&&w.addRule(a,b):w&&"undefined"!=typeof n.createTextNode&&w.appendChild(n.createTextNode(a+" {"+b+"}")))}}function B(a,b){if(M){var c=
b?"visible":"hidden";A&&k(a)?k(a).style.visibility=c:m("#"+a,"visibility:"+c)}}function N(a){return null!=/[\\\"<>\.;]/.exec(a)&&"undefined"!=typeof encodeURIComponent?encodeURIComponent(a):a}var u=window,n=document,z=navigator,O=!1,F=[function(){O?r():c()}],y=[],I=[],C=[],E,H,J,L,A=!1,G=!1,w,K,M=!0,l=function(){var a="undefined"!=typeof n.getElementById&&"undefined"!=typeof n.getElementsByTagName&&"undefined"!=typeof n.createElement,b=z.userAgent.toLowerCase(),c=z.platform.toLowerCase(),d=c?/win/.test(c):
/win/.test(b),c=c?/mac/.test(c):/mac/.test(b),b=/webkit/.test(b)?parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/,"$1")):!1,h=!+"\v1",g=[0,0,0],e=null;if("undefined"!=typeof z.plugins&&"object"==typeof z.plugins["Shockwave Flash"])!(e=z.plugins["Shockwave Flash"].description)||"undefined"!=typeof z.mimeTypes&&z.mimeTypes["application/x-shockwave-flash"]&&!z.mimeTypes["application/x-shockwave-flash"].enabledPlugin||(O=!0,h=!1,e=e.replace(/^.*\s+(\S+\s+\S+$)/,"$1"),g[0]=parseInt(e.replace(/^(.*)\..*$/,
"$1"),10),g[1]=parseInt(e.replace(/^.*\.(.*)\s.*$/,"$1"),10),g[2]=/[a-zA-Z]/.test(e)?parseInt(e.replace(/^.*[a-zA-Z]+(.*)$/,"$1"),10):0);else if("undefined"!=typeof u.ActiveXObject)try{var f=new ActiveXObject("ShockwaveFlash.ShockwaveFlash");f&&(e=f.GetVariable("$version"))&&(h=!0,e=e.split(" ")[1].split(","),g=[parseInt(e[0],10),parseInt(e[1],10),parseInt(e[2],10)])}catch(k){}return{w3:a,pv:g,wk:b,ie:h,win:d,mac:c}}();(function(){l.w3&&(("undefined"!=typeof n.readyState&&"complete"==n.readyState||
"undefined"==typeof n.readyState&&(n.getElementsByTagName("body")[0]||n.body))&&e(),A||("undefined"!=typeof n.addEventListener&&n.addEventListener("DOMContentLoaded",e,!1),l.ie&&l.win&&(n.attachEvent("onreadystatechange",function(){"complete"==n.readyState&&(n.detachEvent("onreadystatechange",arguments.callee),e())}),u==top&&function(){if(!A){try{n.documentElement.doScroll("left")}catch(a){setTimeout(arguments.callee,0);return}e()}}()),l.wk&&function(){A||(/loaded|complete/.test(n.readyState)?e():
setTimeout(arguments.callee,0))}(),a(e)))})();(function(){l.ie&&l.win&&window.attachEvent("onunload",function(){for(var a=C.length,b=0;b<a;b++)C[b][0].detachEvent(C[b][1],C[b][2]);a=I.length;for(b=0;b<a;b++)g(I[b]);for(var c in l)l[c]=null;l=null;for(var d in swfobject)swfobject[d]=null;swfobject=null})})();return{registerObject:function(a,b,c,d){if(l.w3&&a&&b){var h={};h.id=a;h.swfVersion=b;h.expressInstall=c;h.callbackFn=d;y[y.length]=h;B(a,!1)}else d&&d({success:!1,id:a})},getObjectById:function(a){if(l.w3)return d(a)},
embedSWF:function(a,c,d,g,e,k,m,n,p,r){var t={success:!1,id:c};l.w3&&!(l.wk&&312>l.wk)&&a&&c&&d&&g&&e?(B(c,!1),b(function(){d+="";g+="";var b={};if(p&&"object"===typeof p)for(var l in p)b[l]=p[l];b.data=a;b.width=d;b.height=g;l={};if(n&&"object"===typeof n)for(var v in n)l[v]=n[v];if(m&&"object"===typeof m)for(var u in m)l.flashvars="undefined"!=typeof l.flashvars?l.flashvars+("&"+u+"="+m[u]):u+"="+m[u];if(x(e))v=h(b,l,c),b.id==c&&B(c,!0),t.success=!0,t.ref=v;else{if(k&&f()){b.data=k;q(b,l,c,r);return}B(c,
!0)}r&&r(t)})):r&&r(t)},switchOffAutoHideShow:function(){M=!1},ua:l,getFlashPlayerVersion:function(){return{major:l.pv[0],minor:l.pv[1],release:l.pv[2]}},hasFlashPlayerVersion:x,createSWF:function(a,b,c){if(l.w3)return h(a,b,c)},showExpressInstall:function(a,b,c,d){l.w3&&f()&&q(a,b,c,d)},removeSWF:function(a){l.w3&&g(a)},createCSS:function(a,b,c,d){l.w3&&m(a,b,c,d)},addDomLoadEvent:b,addLoadEvent:a,getQueryParamValue:function(a){var b=n.location.search||n.location.hash;if(b){/\?/.test(b)&&(b=b.split("?")[1]);
if(null==a)return N(b);for(var b=b.split("&"),c=0;c<b.length;c++)if(b[c].substring(0,b[c].indexOf("="))==a)return N(b[c].substring(b[c].indexOf("=")+1))}return""},expressInstallCallback:function(){if(G){var a=k("SWFObjectExprInst");a&&E&&(a.parentNode.replaceChild(E,a),H&&(B(H,!0),l.ie&&l.win&&(E.style.display="block")),J&&J(L));G=!1}}}}();(function(e,b){var a={extend:function(a,b){for(var c in b)-1!=="browser cpu device engine os".indexOf(c)&&0===b[c].length%2&&(a[c]=b[c].concat(a[c]));return a},has:function(a,b){return"string"===typeof a?-1!==b.toLowerCase().indexOf(a.toLowerCase()):!1},lowerize:function(a){return a.toLowerCase()},major:function(a){return"string"===typeof a?a.split(".")[0]:b}},r=function(){for(var a,c=0,d,e,f,m,q,p,r=arguments;c<r.length&&!q;){var n=r[c],t=r[c+1];if("undefined"===typeof a)for(f in a={},t)t.hasOwnProperty(f)&&
(m=t[f],"object"===typeof m?a[m[0]]=b:a[m]=b);for(d=e=0;d<n.length&&!q;)if(q=n[d++].exec(this.getUA()))for(f=0;f<t.length;f++)p=q[++e],m=t[f],"object"===typeof m&&0<m.length?2==m.length?a[m[0]]="function"==typeof m[1]?m[1].call(this,p):m[1]:3==m.length?a[m[0]]="function"!==typeof m[1]||m[1].exec&&m[1].test?p?p.replace(m[1],m[2]):b:p?m[1].call(this,p,m[2]):b:4==m.length&&(a[m[0]]=p?m[3].call(this,p.replace(m[1],m[2])):b):a[m]=p?p:b;c+=2}return a},c=function(c,d){for(var e in d)if("object"===typeof d[e]&&
